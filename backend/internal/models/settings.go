...
type Settings struct {
	...
	AllowedExternalPaths      SettingVariable `key:"allowedExternalPaths,envOverride" meta:"label=Allowed External Paths;type=text;keywords=external,files,paths,allowed,directories,absolute,include,custom;category=general;description=Comma-separated list of absolute paths where include and custom files can be located outside the project directory"`
